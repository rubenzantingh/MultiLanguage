...
MultiLanguageSpellData['en'][464728] = {name = "Jump Hill Port Button", additional_info = nil}
MultiLanguageSpellData['en'][464734] = {name = "APG2000 Port Button", additional_info = nil}
MultiLanguageSpellData['en'][464735] = {name = "APG2000", additional_info = nil}
MultiLanguageSpellData['en'][464736] = {name = "Concentrated Toxin", additional_info = "Unlimited range\nInstant\n[q]Ansurek's volatile acid absorbs into the victim, inflicting 575632 Nature damage every 1 sec for 6 sec.\n\n Upon expiration, the toxin detonates, applying Reaction Trauma to the victim and inflicting 1726895 Nature damage to players within 15 yards."}
MultiLanguageSpellData['en'][464739] = {name = "Sharpen Spines", additional_info = "2 sec cast\n[q]Sharp Quillboar spines pierce melee attackers for 1 Physical damage."}
...
MultiLanguageSpellData['en'][464895] = {name = "Hand of Gul'dan", additional_info = "40 yd range\n1.5 sec cast\n[q]Calls down a demonic meteor full of Wild Imps which burst forth to attack the target.\n\n Deals up to [3 * (46.4063% of Spell power)] Shadowflame damage on impact to all enemies within 8 yds of the target and summons up to 3 Wild Imps, based on Soul Shards consumed."}
...
MultiLanguageSpellData['en'][464903] = {name = "Implosion", additional_info = "40 yd range\n{Instant} {10 sec cooldown}\n[q]Demonic forces suck all of your Wild Imps toward the target, and then cause them to violently explode, dealing (47.4375% of Spell power) Shadowflame damage to all enemies within 8 yards."}
...
MultiLanguageSpellData['en'][464932] = {name = "Blizzard", additional_info = "35 yd range\n2 sec cast\n[q]Ice shards pelt the target area, dealing [(15% of Spell power) * 8] Frost damage over 8 sec and reducing movement speed by 50% for 8 sec."}
...
MultiLanguageSpellData['en'][465012] = {name = "Slam", additional_info = "3.2 sec cast\n[q]Stomp the ground, inflicting 1081174 Nature damage to enemies within 60 yds."}
...
MultiLanguageSpellData['en'][465051] = {name = "Xal'atath's Bargain: Devour", additional_info = "[q0]Mythic+ Affixes\n100 yd range\n4 sec cast\n[q]Xal'atath tears open rifts that devour the essence of players, inflicting Shadow damage equal to 1% of their max health every 1 sec for 15 sec. After 15 sec the void rift releases its energy, healing enemies for 2% of their max health every 2 sec for 10 sec. This effect stacks.\n\n Void rift collapses after it is dispelled or target player receives 47 healing. Remnant void energy empowers players in combat, granting them 4% Critical Chance and 2% max health for 30 sec. This effect stacks."}
...
MultiLanguageSpellData['en'][465136] = {name = "Lingering Void", additional_info = "[q0]Mythic+ Affixes\nUnlimited range\nInstant\n[q]Remnant energy from the void rift empowers the player, increasing their Critical Chance by 4% and max health by 2%. This effect stacks."}
MultiLanguageSpellData['en'][465140] = {name = "Lingering Void", additional_info = nil}
...
MultiLanguageSpellData['en'][465402] = {name = "Light's Beacon", additional_info = "60 yd range\n[q]Wrap a single ally in holy energy, causing your heals on other party or raid members to also heal that ally for 10% of the amount healed."}
...
MultiLanguageSpellData['en'][465536] = {name = "WoW Anniversary", additional_info = nil}
...
MultiLanguageSpellData['en'][465633] = {name = "Daily Credit", additional_info = nil}
MultiLanguageSpellData['en'][465634] = {name = "Daily Credit", additional_info = nil}
MultiLanguageSpellData['en'][465635] = {name = "Daily Credit", additional_info = "Instant"}
MultiLanguageSpellData['en'][465636] = {name = "Daily Credit", additional_info = "Instant"}
...
MultiLanguageSpellData['en'][465640] = {name = "Daily Credit", additional_info = nil}
...
MultiLanguageSpellData['en'][465717] = {name = "Elemental Blast", additional_info = "100 yd range\nInstant\n[q]Harnesses the raw power of the elements, dealing (260.489% of Spell power) Elemental damage and increasing your Critical Strike or Haste by 3% or Mastery by (3 * 1.875 )% for 10 sec."}
...
MultiLanguageSpellData['en'][465940] = {name = "Putrid Breath", additional_info = "3 sec cast\n[q]A horrible blast of putrid breath inflicts 3 Nature damage to all enemies in front of the caster every 5.2 sec for until canceled."}
...
MultiLanguageSpellData['en'][466716] = {name = "Bellow", additional_info = "30 yd range\n2 sec cast\n[q]A booming yell inflicts Sonic damage to all enemies around the caster and reduces their movement speed by 50% for 10 sec."}
...
MultiLanguageSpellData['en'][466882] = {name = "Paint Target", additional_info = "60 yd range\n{2 sec cast} {15 sec cooldown}\n[q]Paint a target location, causing a powerful warhead to land there after 1 sec, dealing 500000 Fire damage to all enemies within 20 yards.\n\n Usable in the outdoor areas of Siren Isle."}
...
MultiLanguageSpellData['en'][467767] = {name = "Wayward Vrykul's Lantern", additional_info = "[q]Casting a major class cooldown imbues you with the ferocity of vrykul spirits, granting 171 Critical Strike for 8 sec.\n\n This effect's duration is increased by up to 40 sec based on when you were last imbued."}
...
MultiLanguageSpellData['en'][467911] = {name = "Bleak Powder", additional_info = "40 yd range\n[q]Beast Mastery\n Casting Black Arrow while Beast Cleave is active causes Black Arrow to explode upon hitting a target, dealing (412.5% of Attack power) Shadow damage to nearby enemies.\n\nMarksmanship\n Casting Black Arrow while Trick Shots is active causes Black Arrow to explode upon hitting a target, dealing (412.5% of Attack power) Shadow damage to nearby enemies.\n\n(700ms cooldown)"}
MultiLanguageSpellData['en'][467912] = {name = "Bleak Powder", additional_info = "100 yd range\nInstant\n[q]Casting Black Arrow while [ Beast Mastery : Beast Cleave /\n\nMarksmanship\nTrick Shots ] is active causes Black Arrow to explode upon hitting a target, dealing (412.5% of Attack power) Shadow damage to nearby enemies."}
...
MultiLanguageSpellData['en'][468493] = {name = "Overpower", additional_info = "Melee Range\n1 sec cast\n[q]Effect0: Inflicts Physical damage to an enemy. Cannot be blocked, dodged, or parried."}
...
MultiLanguageSpellData['en'][469882] = {name = "Refining Fire", additional_info = "Unlimited range\nInstant\n[q]Enemies struck by Avenger's Shield burn with holy fire, suffering (112.5% of Attack power) Radiant damage over 5 sec."}
...
MultiLanguageSpellData['en'][470596] = {name = "Frostfire Burst", additional_info = "100 yd range\nInstant\n[q]Fire\nReaching maximum stacks of Fire Mastery causes your next Fire Blast to explode in a Frostfire Burst, dealing (156.25% of Spell power) Frostfire damage to nearby enemies. Damage reduced beyond 8 targets.\n\n Frostfire Burst, reduces the cooldown of Phoenix Flames by 10 sec.\n\nFrost\nReaching maximum stacks of Fire Mastery causes your next Ice Lance to explode in a Frostfire Burst, dealing (156.25% of Spell power) Frostfire damage to nearby enemies. Damage reduced beyond 8 targets.\n\n Frostfire Burst, grants Brain Freeze."}
...
MultiLanguageSpellData['en'][472558] = {name = "Blade Dance", additional_info = "35 Energy\n{Instant} {10 sec cooldown}\n[q]Strike nearby enemies for [3 * (15.84% of Attack power)% + (47.5224% of Attack power)%] Physical damage. Deals reduced damage beyond 5 targets."}
...
MultiLanguageSpellData['en'][472637] = {name = "Runecaster's Stormbound Rune", additional_info = "40 yd range\nInstant\n[q]Every 6 sec spent in combat causes the rune to overcharge, striking a nearby enemy with lightning dealing 187 Nature damage.\n\n This effect triggers immediately when striking a creature for the first time."}
MultiLanguageSpellData['en'][472649] = {name = "Immolation Aura", additional_info = "{Instant} {28 sec cooldown}\n[q]Engulf yourself in flames, radiating [(11.3316% of Attack power) * 10] Fire damage over 10 sec.\n [\nGenerates 0 Fury. ]"}
MultiLanguageSpellData['en'][472651] = {name = "Immolation Aura", additional_info = "Instant\n[q]Havoc\nEngulf yourself in flames, radiating [(11.3316% of Attack power) * 6] Fire damage over 6 sec.\n [\nGenerates 20 Fury. ]\nVengeance\nEngulf yourself in flames, radiating [(11.3316% of Attack power) * 6] Fire damage over 6 sec.\n [\nGenerates 20 Fury. ]\nGenerates 20 Fury over 6 sec."}
...
MultiLanguageSpellData['en'][473547] = {name = "Sleepy Liu", additional_info = nil}
...
MultiLanguageSpellData['en'][474100] = {name = "Hallowfall Supply Cache", additional_info = "{Instant} {30 sec cooldown}\n[q]Carry your crate full of Hallowfall supplies."}
...
MultiLanguageSpellData['en'][474139] = {name = "Sit on Crate", additional_info = "{Instant} {30 sec cooldown}\n[q]Take a seat on the Arathi Crate."}
...
MultiLanguageSpellData['en'][1214207] = {name = "Enhancement Shaman", additional_info = "[q]Modifies Damage/Healing Done -17%:\nChain Lightning , Lightning Bolt"}
...
MultiLanguageSpellData['en'][1215211] = {name = "Expedition Compass", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your expedition compass."}
MultiLanguageSpellData['en'][1215214] = {name = "Priory Censer", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your handheld censer."}
MultiLanguageSpellData['en'][1215215] = {name = "Arathi Tinderbox", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your tinderbox."}
MultiLanguageSpellData['en'][1215216] = {name = "Airship Blueprints", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your airship blueprints."}
MultiLanguageSpellData['en'][1215217] = {name = "Lamplighter's Torch", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your torch."}
...
MultiLanguageSpellData['en'][1215220] = {name = "Handheld Astroglobe", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your portable astroglobe."}
MultiLanguageSpellData['en'][1215222] = {name = "Prismatic Codex", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your prismatic codex."}
...
MultiLanguageSpellData['en'][1215458] = {name = "Machinist's Lantern", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your lantern."}
MultiLanguageSpellData['en'][1215459] = {name = "Glittering Gemstone", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find a glittering gemstone."}
MultiLanguageSpellData['en'][1215460] = {name = "Sit on Crate", additional_info = "{Instant} {30 sec cooldown}\n[q]Take a seat on the supply crate."}
MultiLanguageSpellData['en'][1215461] = {name = "Awakened Supply Crate", additional_info = "{Instant} {30 sec cooldown}\n[q]Carry your crate full of Dornogal supplies."}
MultiLanguageSpellData['en'][1215462] = {name = "Archivist's Databank", additional_info = "{Instant} {15 sec cooldown}\n[q]Rummage through the crate to find your databank."}
MultiLanguageSpellData['en'][1215463] = {name = "Redeployment Module", additional_info = "Instant 30 min recharge\n1 Charges\n[q]Returns you to <Hearthstone Location>. Speak to an Innkeeper in a different place to change your home location."}
...
MultiLanguageSpellData['en'][1217281] = {name = "Redeployment Module", additional_info = "10 sec cast 30 min recharge\n1 Charges\n[q]Returns you to <Hearthstone Location>. Speak to an Innkeeper in a different place to change your home location."}
...
MultiLanguageSpellData['en'][1217539] = {name = "Redeployment Module", additional_info = "Instant 30 min recharge\n1 Charges\n[q]Returns you to <Hearthstone Location>. Speak to an Innkeeper in a different place to change your home location."}
